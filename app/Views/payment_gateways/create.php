            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="fas fa-plus me-2"></i>Add Payment Gateway
                    </h4>
                </div>
                <div class="card-body">
                    <form action="/admin/payment-gateways" method="POST">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" required
                                       placeholder="e.g., FPX Online Banking">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="code" name="code" required
                                       placeholder="e.g., fpx" pattern="[a-z0-9_]+" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3"
                                      placeholder="Describe the payment gateway..."></textarea>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>Create Payment Gateway
                            </button>
