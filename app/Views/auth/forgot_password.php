...
<head>
    ...
    <title>Lupa Kata Laluan - Sistem Tempahan Aset & Fasiliti</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container">
            <a class="navbar-brand text-white fw-bold" href="/">
                <i class="fas fa-calendar-check me-2"></i>Sistem Tempahan Aset
            </a>

            <div class="d-flex ms-auto">
                <span class="text-white">Sistem Tempahan Aset & Fasiliti</span>
            </div>
        </div>
    </nav>
